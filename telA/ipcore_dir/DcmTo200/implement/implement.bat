...
xst -ifn xst.scr
move DcmTo200_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DcmTo200_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DcmTo200_exdes.ucf DcmTo200_exdes

echo 'Running map'
map -timing -pr b DcmTo200_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm DcmTo200_exdes -w routed.ncd routed.v
cd ..
