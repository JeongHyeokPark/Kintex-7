# 
# Project automation script for telA 
# 
# Created for ISE version 14.3
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source telA.tcl), then you can
...
proc set_project_props {} {
   ...
   project set device "xc5vlx50"
   project set package "ff676"
   project set speed "-2"
   project set top_level_module_type "HDL"
   project set synthesis_tool "XST (VHDL/Verilog)"
   project set simulator "Modelsim-PE VHDL"
...
proc add_source_files {} {
   ...
   xfile add "../common/adc_mon.vhd"
   xfile add "../common/align_defs.vhd"
   xfile add "../common/aligner_new.vhd"
   xfile add "../common/baseline.vhd"
   xfile add "../common/comZone.vhd"
   xfile add "../common/compteur.vhd"
   xfile add "../common/csi_channel.vhd"
   xfile add "../common/ddr_adc.vhd"
   xfile add "../common/e_trigger.vhd"
   xfile add "../common/energy.vhd"
   xfile add "../common/f_channel.vhd"
   xfile add "../common/fastlink/ISER8b.vhd"
   xfile add "../common/fastlink/N_ISERDES8b_MsAllign.vhd"
   xfile add "../common/fastlink/OSER8B.vhd"
   xfile add "../common/fastlink/clkgenerator.vhd"
   xfile add "../common/fastlink/deserialiseur.vhd"
   xfile add "../common/fastlink/fastlink.vhd"
   xfile add "../common/fastlink/ipcore_dir/myfifo.xco"
   xfile add "../common/fastlink/ipcore_dir/myfifo2.xco"
   xfile add "../common/fastlink/serialiseur.vhd"
   xfile add "../common/general_io.vhd"
   xfile add "../common/histogrammer.vhd"
   xfile add "../common/i2c_byte.vhd"
   xfile add "../common/i2c_master.vhd"
   xfile add "../common/identity.vhd"
   xfile add "../common/ipcore_dir/My_sysmon.xco"
   xfile add "../common/ipcore_dir/aligner_ram_128x8.xco"
   xfile add "../common/ipcore_dir/aligner_rom_128x8.xco"
   xfile add "../common/ipcore_dir/dcm_200.xaw"
   xfile add "../common/ipcore_dir/ram_128x16.xco"
   xfile add "../common/ipcore_dir/ram_16x16.xco"
   xfile add "../common/ipcore_dir/ram_1kx14.xco"
   xfile add "../common/ipcore_dir/ram_1kx15.xco"
   xfile add "../common/ipcore_dir/ram_1kx24.xco"
   xfile add "../common/ipcore_dir/ram_256x14.xco"
   xfile add "../common/ipcore_dir/ram_256x16.xco"
   xfile add "../common/ipcore_dir/ram_2kx15.xco"
   xfile add "../common/ipcore_dir/ram_32x16.xco"
   xfile add "../common/ipcore_dir/ram_32x16_single.xco"
   xfile add "../common/ipcore_dir/ram_4kx14.xco"
   xfile add "../common/ipcore_dir/ram_64x16.xco"
   xfile add "../common/ipcore_dir/ram_8kx14.xco"
   xfile add "../common/ipcore_dir/spi_adc_rom.xco"
   xfile add "../common/ipcore_dir/tel_icon.xco"
   xfile add "../common/ipcore_dir/tel_ila.xco"
   xfile add "../common/ipcore_dir/tel_ila_128.xco"
   xfile add "../common/ipcore_dir/tel_ila_36.xco"
   xfile add "../common/ipcore_dir/tel_ila_blknrj.xco"
   xfile add "../common/ipcore_dir/tel_ila_dual_128.xco"
   xfile add "../common/ipcore_dir/tel_ila_trig64.xco"
   xfile add "../common/offset_ctrl.vhd"
   xfile add "../common/pic_itf.vhd"
   xfile add "../common/read_engine_new.vhd"
   xfile add "../common/reader.vhd"
   xfile add "../common/retard_1.vhd"
   xfile add "../common/retard_2.vhd"
   xfile add "../common/s_channel.vhd"
   xfile add "../common/scItf.vhd"
   xfile add "../common/shaper.vhd"
   xfile add "../common/slow_ct_defs.vhd"
   xfile add "../common/spi.vhd"
   xfile add "../common/sysmon.vhd"
   xfile add "../common/tel_defs.vhd"
   xfile add "../common/tel_sysmon.vhd"
   xfile add "../common/telescope.ucf"
   xfile add "../common/telescope.vhd"
   xfile add "../common/terminator.vhd"
   xfile add "../common/trigger.vhd"
   xfile add "../common/usb_get_new.vhd"
   xfile add "../common/usb_itf_new.vhd"
   xfile add "../common/waver.vhd"
   xfile add "../tel_b/gene.vhd"
   xfile add "../tel_b/psSyncGen.vhd"
   xfile add "global_trigger.vhd"
   xfile add "ipcore_dir/get_icon.xco"
   xfile add "ipcore_dir/get_ila.xco"
   xfile add "ipcore_dir/micro_wire_rom.xco"
   xfile add "ipcore_dir/the_pll.v"
   xfile add "micro_wire.vhd"
   xfile add "talk_to_lmk.vhd"
   xfile add "tel_conf_a.vhd"
   xfile add "test_bl.cdc"
   xfile add "virBlock.vhd"
   puts ""
   puts "WARNING: project contains IP cores, synthesis will fail if any of the cores require regenerating."
   puts ""

   # Set the Top Module as well...
   project set top "telescope_arch" "telescope"
...
proc set_process_props {} {
   ...
   project set "User Browsed Strategy Files" "/vol0/Xilinx/14.6/ISE_DS/ISE/data/default.xds"
   ...
   project set "Work Directory" "/home/haein/Downloads/fazia/telA/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "tb_simple" -process "Generate IBIS Model"
